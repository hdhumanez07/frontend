...
export function Home() {
  return (
    ...
    >
      <Link
        to="/login"
        class="flex shadow-sm break-inside bg-black rounded-3xl px-8 py-4 mb-4 w-2/4 dark:bg-slate-800 dark:text-white"
      >
        <div class="flex items-center justify-between flex-1">
          <span class="text-lg font-medium text-white">Empecemos</span>
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"
